...
const DEV_THEME: ThemeDefinition = {
  ...
  ui: {
    appBackground:
      'radial-gradient(circle at top, rgba(23, 34, 28, 0.96) 0%, rgba(8, 10, 12, 0.98) 48%, rgba(3, 4, 5, 1) 100%)',
    panelBorder: 'rgba(57, 255, 20, 0.28)',
    panelBackground:
      'radial-gradient(circle at top, rgba(26, 44, 34, 0.9) 0%, rgba(8, 10, 12, 0.96) 58%, rgba(4, 6, 7, 1) 100%)',
    panelShadow: '0 0 26px rgba(57, 255, 20, 0.12)',
    text: '#e8fff5',
    muted: '#89a59b',
    accent: '#39ff14',
    secondary: '#569cd6',
    warning: '#ffcf5a',
    danger: '#ff6b77',
    logoGlow: 'drop-shadow(0 0 18px rgba(57, 255, 20, 0.5))',
    hudGradient:
      'linear-gradient(to bottom, rgba(0, 0, 0, 0.62) 0%, rgba(0, 0, 0, 0.18) 68%, transparent 100%)',
    controlBg: 'rgba(10, 16, 22, 0.92)',
    score: '#39ff14',
    scoreShadow: '0 0 8px #39ff14',
    badge: '#569cd6',
    badgeShadow: '0 0 10px rgba(86, 156, 214, 0.25)',
    livesColor: '#ff4444',
    livesBackground: 'rgba(50, 0, 0, 0.35)',
    livesBorder: 'rgba(255, 68, 68, 0.35)',
    livesShadow: '0 0 10px rgba(255, 68, 68, 0.9)',
    subtleBorder: 'rgba(255, 255, 255, 0.08)',
    inactiveButtonBorder: '#666',
    inactiveButtonColor: '#b4b4b4',
    selectorBackground: 'rgba(255, 255, 255, 0.03)',
  },
  copy: {
    themeChip: 'DEV DESK',
